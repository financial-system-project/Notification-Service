pipeline {
    ...
    environment {
        IMAGE_NAME = "mahendra3/notification"
    ...
    stages{
        ...
        stage(' 1: cloning repository from GitHub') {
            steps {
                git branch: 'main' ,
                url: ' https://github.com/financial-system-project/Notification-Service.git '
            }
        }
            ...
            steps {
                ...
                withCredentials([string(
                    ...
                    sh """
                        ...
                        cd GitOps/charts/notification


                        sed -i '' '/repository: mahendra3\\/notification/{n;s/tag:.*/tag: "'${BUILD_NUMBER}'"/;}' values.yaml
                        ...
                        git commit -m "Updated image tag to ${BUILD_NUMBER} in Notification service"
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        ...
                        ansible-playbook Deployment/deploy.yaml -i Deployment/inventory.ini -e "argocd_app_name=notification-app"
